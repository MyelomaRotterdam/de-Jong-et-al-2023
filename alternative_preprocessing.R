...
# --------------------------------------------------- #
# READ-ME (IMPORTANT)
# In the paper, subsets are separated for individual analysis using selection of barcodes (available on Github), followed by reprocessing.
# Therefore, the function in this script entails barcode selection to select out subsets of cells (neutrophils, monocytes, progenitors).
# Barcodes are available from the github.
# --------------------------------------------------- #
